...
class ProfileHostedPage extends StatefulWidget {
  const ProfileHostedPage({super.key});
  @override
  State<ProfileHostedPage> createState() => _ProfileHostedPage();
}

class _ProfileHostedPage extends State<ProfileHostedPage> {
  ...
  void initState() {
    super.initState();
    GetList.instance.roomList(uri: '내가 주최한 번개 리스트들 가져오기').then((val) {
